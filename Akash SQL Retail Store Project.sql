...
ALTER TABLE order_header
ADD FOREIGN KEY (SHIPPER_ID) REFERENCES shipper(SHIPPER_ID),
ADD FOREIGN KEY (CUSTOMER_ID) REFERENCES online_customer(CUSTOMER_ID); 

ALTER TABLE order_items
ADD FOREIGN KEY (ORDER_ID) REFERENCES order_header(ORDER_ID),
ADD FOREIGN KEY (PRODUCT_ID) REFERENCES product(PRODUCT_ID); 

ALTER TABLE product
ADD primary key (PRODUCT_ID),
ADD FOREIGN KEY (PRODUCT_CLASS_CODE) REFERENCES product_class(PRODUCT_CLASS_CODE);

ALTER TABLE product_class
ADD primary key (PRODUCT_CLASS_CODE);
...
ALTER TABLE product
ADD FOREIGN KEY (PRODUCT_CLASS_CODE) REFERENCES product_class(PRODUCT_CLASS_CODE);
-- Akash Jha -- SQL Project Solution File
